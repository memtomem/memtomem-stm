...
| `MEMTOMEM_STM_ADVERTISE_OBSERVABILITY_TOOLS` | boolean | `true` | Advertise the `stm_admin` tool (eight operator/admin actions) at import time; `false`, `0` or `no` hides it. | Startup |
<!-- stmconfig-env:end -->
