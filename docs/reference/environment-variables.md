...
| `MEMTOMEM_STM_TEARDOWN_WATCHDOG_SECONDS` | non-negative float | `30.0` | Ceiling on shutdown before the process exits the hard way; `0` disables the backstop. | Startup |
